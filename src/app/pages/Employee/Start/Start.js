            ...
            <div >
                ...
                <div className={styles.detailContainer}>
                    <div className={styles.detailText}>
                        <h3>odau<span style={{ color: "#D7987D" }}>re</span>hon <span style={{ fontWeight: 600 }}>- CHÚNG TÔI SẴN SÀNG HOÀN TIỀN CHO BẠN</span></h3>
                    </div>
                    ...
                    <div className={styles.contentSpace}>
                        ...
                        <div className={styles.listOfContent}>
                            <div className={styles.contentContainer}>
                                ...
                                <p className='p2'>odaurehon đã nhận hơn 200000 trong năm 2023</p>
                            </div>
                            <div className={styles.contentContainer}>
                                <h3>Hơn 350 trạm</h3>
                                <p className='p2'>odaurehon có hơn 350 trạm, nơi đón khắp cả nước giúp khách hàng đến được tận nơi họ cần</p>
                            </div>
                            <div className={styles.contentContainer}>
                                <h3>Hơn 1000 chuyến xe</h3>
                                <p className='p2'>odaurehon có hone 1000 chuyến xe chạy mỗi ngày trong tuần</p>
                            </div>
                        </div>
                    </div>
                </div>
