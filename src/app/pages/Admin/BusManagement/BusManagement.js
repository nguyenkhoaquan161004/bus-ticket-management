...
const columns = [
    ...
    { field: 'numOfSeats', headerName: 'Số ghế', width: 80, headerAlign: 'center' },
    { field: 'carId', headerName: 'Biển số', width: 126, headerAlign: 'center' },
    { field: 'type', headerName: 'Loại xe', width: 168, headerAlign: 'center' },
    { field: 'routes', headerName: 'Tuyến xe', width: 200, headerAlign: 'center' },
    { field: 'driver', headerName: 'Tài xế', width: 200, headerAlign: 'center' },
];
...
const BusManagement = () => {
    ...
    const updateBus = (updateNumOfSeats, updateCarId, updateType, updateRoutes, updateDriver) => {
        ...
        <div>
                ...
                <div className={styles.genaralContainer}>
                    <div className={styles.inputSelectionContainer}>
                        ...
                        <div className={styles.inputLocationContainer}>
                            ...
                            <input
                                ...
                                className={styles.inputLocation}
                                value={searchCarId}
                                onChange={(e) => setSearchCarId(e.target.value)}></input>
                        </div>
                        <div className={styles.inputLocationContainer}>
                            ...
                            <input
                                ...
                                className={styles.inputLocation}
                                value={searchDriver}
                                onChange={(e) => setSearchDriver(e.target.value)}></input>
                        </div>
                        <button
                            style={{ border: 'none' }}
                    ...
                    <div className={styles.toolsManagerContainer}>
                        <button className={styles.addButotn}>
                            <InlineIcon className={styles.icon} icon="ic:round-add" onClick={handleAddBusButtonCLick}></InlineIcon>
                        </button>
                        <button className={styles.deleteButotn}>
                            <InlineIcon className={styles.icon} icon="pepicons-pop:line-x" onClick={handleDeleteBus}></InlineIcon>
                        </button>
                        <button className={styles.updateButotn}>
                            <InlineIcon className={styles.icon} icon="bxs:pencil" onClick={handleOpenUpdateBusButtonClick}></InlineIcon>
                        </button>
                    </div>
                </div>

                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <Paper sx={{ height: "646px", width: "65%", margin: "0 30px", marginTop: "67px", overflowY: "hidden" }}>
                        <DataGrid
                            rows={fillteredRows}
                            columns={columns}
            ...
            {isUpdateBusOpen && (
                <UpdateBus
                    ...
                    driver={selectedRowId.driver}></UpdateBus>
            )}
