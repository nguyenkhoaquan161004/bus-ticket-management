...
const SignUp = () => {
    ...
    return (
        <div className={styles.mainContainer}>
            ...
            <div className={styles.fillInputContainer}>
                <div className={styles.inputDoubleItem}>
                    ...
                    <div className={styles.inputGender}>
                        ...
                        <select className={styles.genderBox} value={selectedValue} onChange={handleChange}>
                ...
                <div className={styles.inputItem}>
                    ...
                    <input type="email" placeholder='0xxx xxx xxx'></input>
                </div>
                <div className={styles.inputItem}>
                    <p className='uiSemibold'>CCCD</p>
                    <input type="number" placeholder='0xxx xxx xxx'></input>
                </div>
                <div className={styles.inputPasswordItem}>
                    <div className={styles.inputPassword}>
                        <p className='uiSemibold'>Mật khẩu</p>
                        <input type="password" placeholder='0xxx xxx xxx'></input>
                    </div>
                    <div className={styles.inputPassword}>
            ...
            <button className={styles.buttonSignUp}><h4>Đăng ký</h4></button>
        </div>
    );
};
